train_test = function(I1, I2, t, eta = 0.01, epochs = 10){
  ...
  for (i in 1:epochs){
    ...
    net_h1 = I1[i] * w11 + I2[i] * w21
    net_h2 = I1[i] * w12 + I2[i] * w22
    net_h3 = I1[i] * w13 + I2[i] * w23
    ...
    delta_w11 = delta_h1 * I1[i]
    delta_w12 = delta_h2 * I1[i]
    delta_w13 = delta_h3 * I1[i]
    delta_w21 = delta_h1 * I2[i]
    delta_w22 = delta_h2 * I2[i]
    delta_w23 = delta_h3 * I2[i]
...
out = train_test(I1 = I1,
                 I2 = I2,
                 t = t,
                 eta = 0.0001,
                 epochs = 100000)

plot(x = 1:out$epochs, y = out$errors, type = "l")

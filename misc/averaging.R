...
train_ff_bp = function(training_samples = 1, eta = 0.01, epochs = 1000){
...
plot(1:trained$steps, trained$E, type = "l", 
     xlab = "Step", ylab = "Error", col = "gray70",
     main = "Error: Per-Step vs Epoch Average")
# Convert epoch indices to step indices for overlay
epoch_steps <- seq(2, trained$steps, by = 4)  # Middle of each epoch's 4 steps
lines(epoch_steps, trained$E_epoch, col = "red", lwd = 2)
